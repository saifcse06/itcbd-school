		    ...
		    <div class="col-sm-3">
		    	<div class="box box-primary">
		      		<div class="box-body box-profile">
		              	...
		              	<h3 class="profile-username text-center"><?=$profile->srname?>(<?=$profile->bangla_name?>)</h3>
		              	...
		              	<div class="active tab-pane" id="profile">
			            	<div class="panel-body profile-view-dis">
			            		<div class="row">
				                    ...
				                    <div class="profile-view-tab">
				                        <p><span><?=$this->lang->line("student_birth_certificate")?> </span>:
				                        <?=$profile->birth_certificate?></p>
				                    </div>
				                    <div class="profile-view-tab">
				                        <p><span><?=$this->lang->line("student_present_address")?> </span>:
				                        <?=$this->lang->line("student_village")?>:<?=$profile->present_village?>
				                        <?=$this->lang->line("student_thana")?>:<?=$profile->present_thana?>
				                        <?=$this->lang->line("student_district")?>:<?=$profile->present_district?>
										</p>
				                    </div>
				                    <div class="profile-view-tab">
				                        <p><span><?=$this->lang->line("student_permanent_address")?> </span>:
				                        <?=$this->lang->line("student_village")?>:<?=$profile->permanent_village?>
				                        <?=$this->lang->line("student_thana")?>:<?=$profile->permanent_thana?>
				                        <?=$this->lang->line("student_district")?>:<?=$profile->permanent_district?>
										</p>
				                    </div>
				                    <div class="profile-view-tab">
				                        <p><span><?=$this->lang->line("student_fathers_name")?> </span>:
				                        <?=$profile->fathers_name?></p>
				                    </div>
				                    <div class="profile-view-tab">
				                        <p><span><?=$this->lang->line("student_fathers_profession")?> </span>:
				                        <?=$profile->fathers_profession?></p>
				                    </div>
				                    <div class="profile-view-tab">
				                        <p><span><?=$this->lang->line("student_fathers_nid")?> </span>:
				                        <?=$profile->fathers_nid?></p>
				                    </div>
									<?php if ($profile->fathers_file) {?>
				                    <div class="profile-view-tab">
				                        <p><span><?=$this->lang->line("student_fathers_file")?> </span>:
				                         <a style="color: dodgerblue;" href="<?=base_url('uploads/images/' . $profile->fathers_file)?>" download="<?=$profile->fathers_file?>">Download</a></p>
				                    </div>
									<?php }?>
				                    <div class="profile-view-tab">
				                        <p><span><?=$this->lang->line("student_mothers_name")?> </span>:
				                        <?=$profile->mothers_name?></p>
				                    </div>
									<div class="profile-view-tab">
				                        <p><span><?=$this->lang->line("student_mothers_profession")?> </span>:
				                        <?=$profile->mothers_profession?></p>
				                    </div>
				                    <div class="profile-view-tab">
				                        <p><span><?=$this->lang->line("student_mothers_nid")?> </span>:
				                        <?=$profile->mothers_nid?></p>
				                    </div>
                                    <?php if ($profile->mothers_file) {?>
									<div class="profile-view-tab">
				                        <p><span><?=$this->lang->line("student_mothers_file")?> </span>:
				                         <a style="color: dodgerblue;" href="<?=base_url('uploads/images/' . $profile->mothers_file)?>" download="<?=$profile->mothers_file?>">Download</a></p>
				                    </div>
				                    ...
				                    <div class="profile-view-tab">
				                        <p><span><?=$this->lang->line("student_gurdian_profession")?> </span>: <?=$profile->gurdian_profession?></p>
				                    </div>
				                    <div class="profile-view-tab">
				                        <p><span><?=$this->lang->line("student_gurdian_phone_no")?> </span>: <?=$profile->gurdian_phone_no?></p>
				                    </div>
				                    <div class="profile-view-tab">
				                        <p><span><?=$this->lang->line("student_gurdian_without_father")?> </span>: <?=$profile->gurdian_without_father?></p>
				                    </div>
				                    <div class="profile-view-tab">
				                        <p><span><?=$this->lang->line("student_relation_with_student")?> </span>: <?=$profile->relation_with_student?></p>
				                    </div>
				                    <div class="profile-view-tab">
				                        <p><span><?=$this->lang->line("student_gurdian_without_father_phone")?> </span>: <?=$profile->gurdian_without_father_phone_no?></p>
				                    </div>
				                    <div class="profile-view-tab">
				                        <p><span><?=$this->lang->line("student_stipend")?> </span>: <?=$this->lang->line("student_" . $profile->stipend)?></p>
				                    </div>
				                    <div class="profile-view-tab">
				                        <p><span><?=$this->lang->line("student_merit_stipend")?> </span>: <?=$this->lang->line("student_" . $profile->merit_stipend)?></p>
				                    </div>
				                    <div class="profile-view-tab">
				                        <p><span><?=$this->lang->line("student_others_stipend")?> </span>: <?=$this->lang->line("student_" . $profile->others_stipend)?></p>
				                    </div>
				                    <div class="profile-view-tab">
				                        <p><span><?=$this->lang->line("student_orphan")?> </span>: <?=$this->lang->line("student_" . $profile->orphan)?></p>
				                    </div>
				                    <div class="profile-view-tab">
				                        <p><span><?=$this->lang->line("student_physically_chalanged")?> </span>: <?=$this->lang->line("student_" . $profile->physically_chalanged)?></p>
				                    </div>
				                    <div class="profile-view-tab">
				                        <p><span><?=$this->lang->line("student_freedom_fighter")?> </span>: <?=$this->lang->line("student_" . $profile->freedom_fighter)?></p>
				                    </div>
				                    <div class="profile-view-tab">
				                        <p><span><?=$this->lang->line("student_previous_school")?> </span>: <?=$profile->previous_school?></p>
				                    </div>
				                    <div class="profile-view-tab">
				                        <p><span><?=$this->lang->line("student_previous_class")?> </span>: <?=$profile->previous_class?></p>
				                    </div>
				                    <div class="profile-view-tab">
				                        <p><span><?=$this->lang->line("student_previous_grade")?> </span>: <?=$profile->previous_grade?></p>
				                    </div>
						        </div>
					        </div>
		              	</div>
...
$optionalsubjectID = $profile->sroptionalsubjectID;
        ...
        $totalWeaver                              = 0;
        $totalDue                                 = 0;
        $totalFine                                = 0;if (customCompute($invoices)) {
...
$status    = $invoice->paidstatus;
                ...
                $totalInvoice += $invoiceAmount;?>
				                                    ...
				                                    <td data-title="<?=$this->lang->line('student_discount')?>">
				                                        <?php $discountAmount = 0;if ($invoice->discount > 0) {$discountAmount = (($invoice->amount / 100) * $invoice->discount);}
                echo number_format($discountAmount, 2);
                $totalDiscount += $discountAmount;?>
				                                    </td>

				                                    <td data-title="<?=$this->lang->line('student_paid')?>">
				                                        <?php $paymentAmount = 0;if (isset($allpaymentbyinvoice[$invoice->invoiceID])) {$paymentAmount = $allpaymentbyinvoice[$invoice->invoiceID];}
                echo number_format($paymentAmount, 2);
                $totalPaid += $paymentAmount;?>
				                                    </td>

				                                    <td data-title="<?=$this->lang->line('student_weaver')?>">
				                                        <?php $weaverAmount = 0;if (isset($allweaverandpaymentbyinvoice[$invoice->invoiceID]['weaver'])) {$weaverAmount = $allweaverandpaymentbyinvoice[$invoice->invoiceID]['weaver'];}
                echo number_format($weaverAmount, 2);
                $totalWeaver += $weaverAmount;?>
				                                    </td>

				                                    <td data-title="<?=$this->lang->line('student_fine')?>">
				                                        <?php $fineAmount = 0;if (isset($allweaverandpaymentbyinvoice[$invoice->invoiceID]['fine'])) {$fineAmount = $allweaverandpaymentbyinvoice[$invoice->invoiceID]['fine'];}
        ...
        $totalPaymentFine                             = 0;if (customCompute($payments)) {
            $i = 1;foreach ($payments as $payment) {
                ?>
						              			<tr>
				                                    <td data-title="<?=$this->lang->line('slno')?>">
				                                        <?php echo $i; ?>
        ...
        ?>
            ...
            $i = 1;foreach ($documents as $document) {
                ?>
						              			<tr>
				                                    <td data-title="<?=$this->lang->line('slno')?>">
				                                        <?php echo $i; ?>
